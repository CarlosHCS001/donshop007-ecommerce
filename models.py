"""
Modelos do banco de dados do DonShop007
"""
...
class Review(db.Model):
    ...
    # Índice composto para garantir uma avaliação por usuário por produto
    __table_args__ = (
...
class Order(db.Model):
    ...
    def total_com_frete(self):
        """Retorna o total do pedido incluindo frete"""
...
class CartItem(db.Model):
    ...
    # Índice composto para garantir um item único por produto no carrinho
    __table_args__ = (
